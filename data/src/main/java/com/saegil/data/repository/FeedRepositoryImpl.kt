...
class FeedRepositoryImpl @Inject constructor(
    ...
    override fun getFeeds(): Flow<PagingData<Notice>> {
        return Pager(
            config = PagingConfig(
                pageSize = 10,
            ...
            pagingSourceFactory = { FeedPagingSource(feedService) } // Paging은 내부적으로 데이터가 갱신될 떄마다 PagingSource를 새로 생성해서 사용해서 이를 위한 매번 인스턴스를 새로 생성할 람다가 필요함
